      ...
      <main className="min-h-screen bg-[#FFFDFB]">
        <div className="mx-auto flex min-h-screen max-w-7xl items-center px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto w-full max-w-3xl rounded-2xl border border-[#F3D4BF] bg-white p-6 shadow-[0_12px_30px_rgba(0,0,0,0.04)] sm:p-8 lg:p-12">
            {/* Top utility row */}
            <div className="mb-8 flex flex-col gap-3 border-b border-[#F3D4BF] pb-6 sm:flex-row sm:items-center sm:justify-between">
              <Link
                href="/"
                className="inline-flex h-11 items-center justify-center rounded-md border border-[#F3D4BF] bg-white px-5 text-sm font-semibold text-(--text-primary) transition duration-300 hover:-translate-y-[2px]"
              >
                Back to Homepage
              </Link>
              ...
              <a
                ...
                className="inline-flex h-11 items-center justify-center rounded-md bg-[#F38744] px-5 text-sm font-semibold text-white transition duration-300 hover:-translate-y-[2px] hover:opacity-95"
              >
            ...
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-[#FFF4ED]">
              <Check size={34} className="text-[#F38744]" strokeWidth={2.4} />
            </div>
            ...
            <div className="mt-8 text-center">
              ...
              <p className="mx-auto mt-5 max-w-xl text-lg leading-8 text-(--text-secondary)">
                Our team will contact you shortly to understand your
                requirements and recommend the best living options for you.
              </p>
            </div>
